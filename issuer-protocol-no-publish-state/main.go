...
func main() {
	...
	fmt.Println("Identity state (hash of tree roots): 0x", state.Hex())
	...
	subjectId, _ := core.IDFromString("2qGKMXEQ53gNohAfxqYNPz6Kg1xYsBSN7ZQGG8tYMc") // Nick's from Polygon ID wallet
